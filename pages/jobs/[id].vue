  ...
  <div>
    ...
    <div v-if="!job" class="min-h-screen bg-black/[0.96] antialiased flex items-center justify-center">
      <div class="text-center z-10">
        ...
        <UButton label="Back to Jobs" icon="i-lucide-arrow-left" size="lg" variant="subtle" />
      </div>
    </div>
    <!-- Job details -->
    <div v-else>
            ...
            <div class="lg:col-span-2">
              ...
              <motion.div :initial="{ opacity: 0, y: 20 }" :animate="{ opacity: 1, y: 0 }" :transition="{
                ...
                <UContainer>
                  ...
                  <!-- Tabs -->
                  <UTabs :items="items" variant="pill" class="gap-4" size="sm">
                    <template #description>
                      <div class="space-y-6">
                        ...
                        <div>
                          ...
                          <ul class="space-y-2">
                            <li class="flex items-start">
                              <UIcon name="lucide:circle-check-big" class="text-green-500 mr-2 mt-0.5 flex-shrink-0 "
                                size="xl" />
                        ...
                        <div>
                          ...
                          <ul class="space-y-2">
                            <li class="flex items-start">
                              <UIcon name="lucide:circle-check-big" class="text-purple-500 mr-2 mt-0.5 flex-shrink-0 "
                                size="xl" />
                    ...
                    <template #company>
                      <div class="space-y-6">
                        <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                          ...
                          <div>
                            <h3 class="text-xl font-semibold text-white">{{ job.company }}
                            </h3>
              ...
              <motion.div :initial="{ opacity: 0, y: 20 }" :animate="{ opacity: 1, y: 0 }" :transition="{
                ...
                <UContainer>
                  <h2 class="text-xl font-bold text-white mb-4">Apply for this position</h2>
                  <div class="space-y-6">
                    <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div class="space-y-3">
                        <h3 class="text-white font-medium">Job Details</h3>
                        <div class="space-y-2">
                          <div class="flex justify-between">
                            <span class="text-gray-400">Experience</span>
                            <span class="text-white">{job.experience || "Not specified"}</span>
                          </div>
                          <div class="flex justify-between">
